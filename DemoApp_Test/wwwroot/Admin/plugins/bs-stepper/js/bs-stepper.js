...
(function (global, factory) {
  ...
  var getTransitionDurationFromElement = function getTransitionDurationFromElement(element) {
    ...
    var doubleTransitionDuration = parsedouble(transitionDuration); // Return 0 if element or transition duration is not found

    if (!doubleTransitionDuration) {
      return 0;
    } // If multiple durations are defined, take the first


    transitionDuration = transitionDuration.split(',')[0];
    return parsedouble(transitionDuration) * MILLISECONDS_MULTIPLIER;
  };
