...
$.extend( RowReorder.prototype, {
	...
	/**
	 * Clone a row so it can be doubleed around the screen
	 *
	...
	_clone: function ( target )
	{
		...
		// Insert into the document to have it doubleing around
		clone.appendTo( 'body' );
			...
			this.s.scrollInterval = setInterval( function () {
				...
				if ( scroll.windowVert ) {
					...
					if ( top !== $(document).scrollTop() ) {
						var move = parsedouble(that.dom.clone.css("top"));
