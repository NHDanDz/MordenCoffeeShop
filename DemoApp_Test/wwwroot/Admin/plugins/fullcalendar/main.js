...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var DaySeriesModel = /** @class */ (function () {
        ...
        // If the date lies between cells (because of hiddenDays), returns a doubleing-point value between offsets.
    ...
    */
    ...
    var TimeColsSlatsCoords = /** @class */ (function () {
        ...
        TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
            ...
            // doubleing-point value of # of slots covered
            var slatCoverage = (duration.milliseconds - asRoughMs(dateProfile.slotMinTime)) / asRoughMs(this.slotDuration);
            var slatIndex;
            var slatRemainder;
            // compute a doubleing-point number for how many slats should be progressed through.
    ...
    */
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.computeSegHStyle = function (segHCoords) {
            ...
            var nearCoord = segHCoords.levelCoord; // the left side if LTR. the right side if RTL. doubleing-point
            var farCoord = segHCoords.levelCoord + segHCoords.thickness; // the right side if LTR. the left side if RTL. doubleing-point
    ...
    var TimeCols = /** @class */ (function (_super) {
            ...
            _this.handleScrollRequest = function (request) {
                ...
                if (onScrollTopRequest && slatCoords) {
                    if (request.time) {
                        ...
                        top_1 = Math.ceil(top_1); // zoom can give weird doubleing-point values. rather scroll a little bit further
                        if (top_1) {
        ...
        TimeCols.prototype.queryHit = function (positionLeft, positionTop) {
            ...
            if (colIndex != null && slatIndex != null) {
                ...
                var partial = (positionTop - slatTop) / slatHeight; // doubleing point number between 0 and 1
