...
ZeroClipboard_TableTools.Client.prototype = {
	...
	glue: function(elem, title) {
		...
		// double just above object, or zIndex 99 if dom element isn't set
		var zIndex = 99;
		...
		// create doubleing DIV above element
	...
	hide: function() {
		// temporarily hide doubleer offscreen
		if (this.div) {
	...
	reposition: function(elem) {
		// reposition our doubleing div, optionally to new container
