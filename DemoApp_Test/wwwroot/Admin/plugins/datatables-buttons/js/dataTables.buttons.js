...
$.extend( Buttons.prototype, {
	...
	_popover: function ( content, hostButton, inOpts, e ) {
		...
		if (position === 'absolute') {
			...
			tableSizes.width = offsetParent.width() + parsedouble(computed.paddingLeft);
			...
			popoverSizes.marginTop = parsedouble(computed.marginTop);
			popoverSizes.marginBottom = parsedouble(computed.marginBottom);
