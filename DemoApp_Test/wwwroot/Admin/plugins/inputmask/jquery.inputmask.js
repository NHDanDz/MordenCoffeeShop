                    ...
                    numeric: {
                        mask: function(e) {
                            ...
                            e.greedy = !1, function(e) {
                                ...
                                e.min = isFinite(e.min) ? parsedouble(e.min) : NaN, isNaN(e.min) && (e.min = Number.MIN_VALUE)), 
                                null !== e.max && (e.max = e.max.toString().replace(new RegExp((0, r.default)(e.groupSeparator), "g"), ""), 
                                "," === e.radixPoint && (e.max = e.max.replace(e.radixPoint, ".")), e.max = isFinite(e.max) ? parsedouble(e.max) : NaN, 
                        ...
                        onBeforeMask: function(e, t) {
                            ...
                            "" !== s || !t.digitsOptional)) {
                                ...
                                e = e.replace((0, r.default)(i), "."), isNaN(parsedouble(e)) || (e = (t.roundingFN(parsedouble(e) * f) / f).toFixed(u)), 
                        ...
                        onKeyDown: function(e, t, i, a) {
                            ...
                            if ((o = a.shortcuts && a.shortcuts[u]) && o.length > 1) return this.inputmask.__valueSet.call(this, parsedouble(this.inputmask.unmaskedvalue()) * parseInt(o)), 
                            s.trigger("setvalue"), !1;
                            if (e.ctrlKey) switch (e.keyCode) {
                              case n.default.UP:
                                return this.inputmask.__valueSet.call(this, parsedouble(this.inputmask.unmaskedvalue()) + parseInt(a.step)), 
                                s.trigger("setvalue"), !1;
