...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
    ...
    elproto.isPointInside = function (x, y) {
        var rp = this.RootImage = getPath[this.type](this);
    ...
    elproto.getBBox = function (isWithoutTransform) {
        ...
        if (isWithoutTransform) {
            if (_.dirty || !_.bboxwt) {
                this.RootImage = getPath[this.type](this);
                _.bboxwt = pathDimensions(this.RootImage);
        ...
        if (_.dirty || _.dirtyT || !_.bbox) {
            if (_.dirty || !this.RootImage) {
                _.bboxwt = 0;
                this.RootImage = getPath[this.type](this);
            }
            _.bbox = pathDimensions(mapPath(this.RootImage, this.matrix));
    ...
    elproto.glow = function (glow) {
        ...
        var s = {
            ...
            r = this.paper,
            out = r.set(),
            path = this.RootImage || getPath[this.type](this);
